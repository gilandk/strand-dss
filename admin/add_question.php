...
if (isset($_POST)) {
  ...
  $sql = "INSERT INTO questions (q_cat, q_scat, question, choice1, choice2, choice3, choice4, answerQ, q_item) VALUES('$q_cat', '$q_scat', '$question', '$choice1', '$choice2', '$choice3', '$choice4', '$ans', '$q_item')";
