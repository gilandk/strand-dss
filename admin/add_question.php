...
if (isset($_POST)) {
  ...
  $sql = "INSERT INTO questions (qs_id, q_cat, q_scat, question, choice1, choice2, choice3, choice4, answerQ) VALUES('$qs_id', '$q_cat', '$q_scat', '$question', '$choice1', '$choice2', '$choice3', '$choice4', '$ans')";
