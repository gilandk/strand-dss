...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      if (isset($_SESSION['updateAdminAccSuccess'])) {
      ?>
      ...
      <?php
        unset($_SESSION['updateAdminAccSuccess']);
      }
      ?>

      <?php
      //If User already registered with this email then show error message.
      if (isset($_SESSION['updateAdminAccFailed'])) {
      ?>
      ...
      <?php
        unset($_SESSION['updateAdminAccFailed']);
      }
      ?>
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary card-outline">
            ...
            <div class="mt-3 ml-3 mr-3 mb-3">
              <form action="update_admin_acc.php" id="admin" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  <label>Role:</label>
                  <select class="form-control" name="role" <?php if ($admin_role == 'Admin') echo 'Disabled' ?>>
