                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group mr-3 ml-3">
                                        ...
                                        <select class="form-control" name="groupQ">
                                            <option value="no" <?php if ($gQ == 'no') echo 'Selected' ?>>No</option>
                                            <option value="yes" <?php if ($gQ == 'yes') echo 'Selected' ?>>Yes</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mr-3 ml-3">
                                        ...
                                        <select class="form-control" name="groupIndex">
                                            <option <?php if ($gIndex == 'None') echo 'Selected' ?>>None</option>
                                            <option <?php if ($gIndex == 'A') echo 'Selected' ?>>A</option>
                                            <option <?php if ($gIndex == 'B') echo 'Selected' ?>>B</option>
                                            <option <?php if ($gIndex == 'C') echo 'Selected' ?>>C</option>
                                            <option <?php if ($gIndex == 'D') echo 'Selected' ?>>D</option>
                                            <option <?php if ($gIndex == 'E') echo 'Selected' ?>>E</option>
                                            <option <?php if ($gIndex == 'F') echo 'Selected' ?>>F</option>
                                            <option <?php if ($gIndex == 'G') echo 'Selected' ?>>G</option>
                                        </select>
                                    </div>
