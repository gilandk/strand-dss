        ...
        <div class="col-md-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title"><?php echo $strandname; ?> <strong>(<?php echo $strandabr; ?>)</strong>
              </h3>
            </div>
            <div class="card-body">
          ...
          <div class="card">
            <div class="card-header">
              <a class="btn btn-primary btn-sm" href="analytics_strands_reports.php?id=<?php echo $s_id; ?>"> View All</a>
            ...
            <div class="card-body">
              <table id="analytics_strands" class="table table-bordered">
                <thead>
                  <tr>
                    <th class="text-center" colspan="4">Top 20 - <?php echo $strandname; ?> (<?php echo $strandabr; ?>)</th>
                  </tr>
                  <tr>
                    <th>Name</th>
                    <th>Exam</th>
