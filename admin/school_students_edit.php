...
$sql = "SELECT * FROM student_info WHERE user_id='$st_id'";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        $section = $row['section'];
        $s_year = $row['s_year'];
        $desired_strand1 = $row['desired_strand1'];
        $desired_strand2 = $row['desired_strand2'];
        $status = $row['status'];
    }
}
                    ...
                    <div class="card card-primary card-outline">
                        <div class="mt-3 ml-3 mr-3 mb-3">
                            <form action="update_student.php" id="students" method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="user_id" value="<?php echo $st_id; ?>">
                                <!-- Default box -->
                                <div class="card collapsed-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label>Age</label>
                                            <input type="number" class="form-control" placeholder="Age" name="age" max="150" value="<?php echo $age; ?>" />
                                        </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class=" form-group">
                                            ...
                                            <select class="form-control" name="strand1">
                                                <option <?php if ($desired_strand1 == $abm) echo "selected" ?>>Accountancy, Business and Management (ABM)</option>
                                                <option <?php if ($desired_strand1 == $stem) echo "selected" ?>>Science Technology Engineering and Mathematics (STEM)</option>
                                                <option <?php if ($desired_strand1 == $he) echo "selected" ?>>Home Economics</option>
                                                <option <?php if ($desired_strand1 == $ict) echo "selected" ?>>Information and Communication Technology (ICT)</option>
                                                <option <?php if ($desired_strand1 == $afa) echo "selected" ?>>Agri-Fishery Arts</option>
                                                <option <?php if ($desired_strand1 == $ia) echo "selected" ?>>Industrial Arts</option>
                                                <option <?php if ($desired_strand1 == $ad) echo "selected" ?>>Arts and Design</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="strand2">
                                                <option <?php if ($desired_strand2 == $abm) echo "selected" ?>>Accountancy, Business and Management (ABM)</option>
                                                <option <?php if ($desired_strand2 == $stem) echo "selected" ?>>Science Technology Engineering and Mathematics (STEM)</option>
                                                <option <?php if ($desired_strand2 == $he) echo "selected" ?>>Home Economics</option>
                                                <option <?php if ($desired_strand2 == $ict) echo "selected" ?>>Information and Communication Technology (ICT)</option>
                                                <option <?php if ($desired_strand2 == $afa) echo "selected" ?>>Agri-Fishery Arts</option>
                                                <option <?php if ($desired_strand2 == $ia) echo "selected" ?>>Industrial Arts</option>
                                                <option <?php if ($desired_strand2 == $ad) echo "selected" ?>>Arts and Design</option>
                                            </select>
                                        </div>
